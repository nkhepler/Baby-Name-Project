...
saveRDS(state_dnn, 'Baby-Name-Project/data/raw_data/state-Nathans-by-year.rds')
...
saveRDS(state_dnn_sum, 'Baby-Name-Project/data/raw_data/state-Nathans-total.rds')
```
